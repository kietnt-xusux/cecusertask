...
export const LoadingIcon = (props: { className?: string, size?: number }) => {
    let sizeClass = props.size ? `h-${props.size} w-${props.size}` : "h-5 w-5",
        customClass = props.className ? props.className : "";

    return <svg className={`animate-spin ${sizeClass} ${customClass}`}
...
export const MenuAlt2Icon = (props: { className?: string }) => {
    let iconClass = props.className ?? "h-5 w-5";
    return <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const CheckIcon = (props: { className?: string }) => {
    let iconClass = props.className ?? "h-5 w-5";
    return <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 20 20" fill="currentColor">
...
export const XIcon = (props: { className?: string, onClick?: () => void }) => {
    let iconClass = props.className ?? "h-5 w-5";
    return <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 20 20" fill="currentColor" onClick={props.onClick}>
...
export const ChevronUpIcon = (props: { className?: string }) => {
    let iconClass = props.className ?? "h-5 w-5";
    return <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 20 20" fill="currentColor">
...
export const UserIcon = ({className}: { className?: string }) => {
    return <svg className={className ?? "h-5 w-5"} fill="currentColor" viewBox="0 0 24 24">
        <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
    </svg>
}

export const BriefcaseIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={props.className ?? "h-5 w-5"} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const WrenchIcon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" className={props.className ?? "h-5 w-5"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75a4.5 4.5 0 01-4.884 4.484c-1.076-.091-2.264.071-2.95.904l-7.152 8.684a2.548 2.548 0 11-3.586-3.586l8.684-7.152c.833-.686.995-1.874.904-2.95a4.5 4.5 0 016.336-4.486l-3.276 3.276a3.004 3.004 0 002.25 2.25l3.276-3.276c.256.565.398 1.192.398 1.852z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.867 19.125h.008v.008h-.008v-.008z" />
    </svg>
)

export const BuildingOffice2Icon = (props: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" className={props.className ?? "h-5 w-5"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" />
    </svg>
)
export const ArchiveIcon = (props: { className?: string }) =>
    <svg xmlns="http://www.w3.org/2000/svg" className={props.className ?? "h-5 w-5"} viewBox="0 0 20 20" fill="currentColor">
        <path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z" />
        <path fillRule="evenodd" d="M3 8h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm5 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" clipRule="evenodd" />
    </svg>

export const PhotographIcon = (props: { className?: string }) =>
    <svg xmlns="http://www.w3.org/2000/svg" className={props.className ?? "h-5 w-5"} viewBox="0 0 20 20" fill="currentColor">
...
export const LinkSquareIcon = ({className}: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className ?? "h-5 w-5"}>
