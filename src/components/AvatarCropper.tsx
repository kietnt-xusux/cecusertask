...
export const AvatarCropper = React.forwardRef<ReactCropperElement | HTMLImageElement, ReactCropperProps>(
    ({ ...props }, ref) => {
        const {
            dragMode = 'crop',
            style,
                    ...
                    <Dialog as='div' className='fixed inset-0 z-[1000] overflow-y-auto' onClose={() => closeModal()}>
                        <div className='min-h-screen px-4 text-center'>
                            ...
                            <TransitionChild
                                ...
                                <div
                                    className='inline-block w-full max-w-2xl p-6 my-8 overflow-hidden text-left align-middle
                                ...
                                >
                                    ...
                                    <div className='flex justify-end mt-4'>
                                        <button
                                            className='w-32 inline-flex justify-center py-2 px-4 border shadow-sm text-sm
                                            font-medium rounded-md bg-white hover:bg-gray-100 focus:outline-none'
                                            onClick={closeModal}>
                                            キャンセル
                                        </button>
                                        <button
                                            className='w-32 ml-4 inline-flex justify-center py-2 px-4 border border-transparent
